...
' delete the event
			...
			response.redirect "webCal4_delete.asp?event_id=" & Request.Form("event_id")
...
<form name="editForm" method="post" id="event" action="webCal4_updated.asp?view=<%=Request.QueryString("view")%>">
