...
dim strQuery, rsStaff, strStaff, rsUser, strDate, strCal
...
<form name="apptForm" method="post" action="webCal4_<%=strCal%>-updated.asp">
...
<tr>
	...
	<b>Reason:</b></font></td>
	<td><font face="Tahoma, Arial, Helvetica" size=2>
		<textarea cols="25" name="reason" type="text" rows="10" wrap="virtual"></textarea>
	</td>
<tr>
