...
if Request.Form("cancel") = "Cancel" then
	response.redirect "webCal4_signup-week.asp?type=" & Request.Form("grade")
end if

dim intStaff, instStudent, strTitle, strStart, strDescription, strEnd
dim strDate, db, strQuery, rsEvent, intID, strCal
...
strDescription = Replace(Request.Form("reason"), "'", "''")
...
' find events on this day for the selected counselor
