...
<form name="userform" action="webCal4_user-edit.asp?view=<%=Request.QueryString("view")%>" method="post">
<tr>
	<td bgcolor="#<%=arColor(4)%>" colspan=2>
   ...
   onMouseOut="iconOut('Month'); return true;">
	...
	<b>Users and Groups</b></font></td>
<tr>
	<td align="right" valign="top" bgcolor="#<%=arColor(12)%>">
...
<tr>
	<td bgcolor="#<%=arColor(5)%>"><font size=1>&nbsp;</td>
	<td bgcolor="#<%=arColor(5)%>"><font size=1>&nbsp;</td>
	
<% end if %>

</form>
<form name="groupform" action="webCal4_group-edit.asp?view=<%=Request.QueryString("view")%>" method="post">
<tr>
	<td align="right" valign="top" bgcolor="#<%=arColor(12)%>">
	<input type="submit" name="add" value="Add">
	</td>
